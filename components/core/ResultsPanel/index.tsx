...
export default function ResultsPanel() {
  ...
  if (!outputs) {
    return (
      <div className="mt-8 text-center text-neutral-platinum-gray">Enter values and calculate to see results.</div>
    );
  }
  ...
  return (
    <div className="mt-8 space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 border rounded shadow-sm bg-brand-white">
          <div className="text-sm text-neutral-platinum-gray">Total Projected Return</div>
          <div className="text-2xl font-display text-royal-gold">${outputs.totalProjectedReturnUSD.toLocaleString()}</div>
        </div>
        <div className="p-4 border rounded shadow-sm bg-brand-white">
          <div className="text-sm text-neutral-platinum-gray">ROI %</div>
      ...
      <div>
        ...
        <table className="w-full text-sm border">
          <thead className="bg-neutral-platinum-gray/20">
            <tr>
          ...
          <tbody>
            {outputs.yearlyBreakdown.map((row) => (
              <tr key={row.year} className="odd:bg-brand-white even:bg-neutral-platinum-gray/10">
